 ...
 */
class TextWatcherObservable(
    private val editText: EditText,
    private val inputFilter: InputFilter? = null
) : Observable<String>() {
    ...
    class Listener(private val editText: EditText, private val observer: Observer<in String>) :
