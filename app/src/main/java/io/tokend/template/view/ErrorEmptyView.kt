...
class ErrorEmptyView @JvmOverloads constructor(
    ...
    init {
        ...
        attributeSet?.let {
            val typedArray =
                context.obtainStyledAttributes(it, R.styleable.ErrorEmptyView, defStyleAttr, 0)
            ...
            val drawableTint =
                typedArray.getColor(R.styleable.ErrorEmptyView_drawable_tint_color, Int.MIN_VALUE)
     ...
     */
    fun showError(
        throwable: Throwable, errorHandler: ErrorHandler,
