...
import io.tokend.template.features.assets.buy.view.adapter.AtomicSwapAskListItem
import io.tokend.template.features.assets.buy.view.adapter.AtomicSwapAsksAdapter
...
import io.tokend.template.view.util.SwipeRefreshDependencyUtil
...
class AtomicSwapAsksFragment : BaseFragment(), ToolbarProvider {
    ...
    private fun initList() {
        ...
        asks_recycler_view.layoutManager =
