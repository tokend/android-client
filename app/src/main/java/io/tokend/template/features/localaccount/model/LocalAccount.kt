package io.tokend.template.features.localaccount.model

import io.tokend.template.features.localaccount.model.LocalAccount.Companion.DEFAULT_ENTROPY_BYTES
import io.tokend.template.features.localaccount.model.LocalAccount.Companion.fromEntropy
...
private constructor(
    ...
    private sealed class EncryptedSource(
        val i: Byte,
    ...
    fun decrypt(
        ...
        when (encryptedSource) {
            ...
            is EncryptedSource.SecretSeed ->
                mSecretSeed =
                    cipher.decrypt(encryptedSource.encryptedData, encryptionKey).toCharArray()
        }
    }
    ...
    companion object {
         ...
         */
        fun fromSerializedEncryptedSource(
            accountId: String,
            serializedEncryptedSource: ByteArray
        ): LocalAccount {
