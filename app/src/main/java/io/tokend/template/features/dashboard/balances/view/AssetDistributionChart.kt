package io.tokend.template.features.dashboard.balances.view
...
@JvmOverloads constructor(
    ...
    init {
        ...
        context.layoutInflater.inflate(
            R.layout.layout_asset_distribution_chart,
            this, true
        )
    ...
    private fun initChart() {
        chart.apply {
            ...
            setCenterTextSizePixels(
                context.resources.getDimensionPixelSize(R.dimen.text_size_default).toFloat()
            )
    ...
    fun setData(
        balances: Collection<BalanceRecord>,
    ...
    private fun displayDistribution(
        distribution: List<AssetDistributionEntry>,
        animate: Boolean
    ) {
    ...
    private fun getLegendEntryView(
        index: Int,
            ...
            addView(
                LinearLayout(context).apply {
                    layoutParams = LayoutParams(
                        ...
                        marginStart =
                            context.resources.getDimensionPixelSize(R.dimen.half_standard_margin)
                    }
                    ...
                    addView(
                        TextView(
                            ContextThemeWrapper(context, R.style.HintText),
                            null,
                            R.style.HintText
                        ).apply {
