...
class ContactExtraCredentialItemViewHolder(view: View) :
    BaseViewHolder<ContactExtraCredentialListItem>(view) {
    private val credentialTextView: TextView = view.findViewById(R.id.contact_credential_text_view)
...
class ContactSectionTitleItemViewHolder(view: View) :
    BaseViewHolder<ContactSectionTitleListItem>(view) {
