package io.tokend.template.features.trade.history.view
...
import io.tokend.template.features.trade.history.view.adapter.TradeHistoryAdapter
...
class TradeHistoryFragment : BaseFragment() {
    ...
    private fun initList() {
        trade_history_list.layoutManager =
