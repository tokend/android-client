...
import io.tokend.template.features.trade.chart.view.AssetPairChartFragment
import io.tokend.template.features.trade.history.view.TradeHistoryFragment
import io.tokend.template.features.trade.offers.view.OffersFragment
import io.tokend.template.features.trade.orderbook.view.OrderBookFragment
import io.tokend.template.features.trade.pairs.model.AssetPairRecord

class TradePagerAdapter(
